...
{
    selectedListDict = [[NSMutableDictionary alloc]init];
    ...
    if (self) {
        ...
        self->textField.tag = self->textField.tag;
...
{
    [selectedListDict setValue:[dataArray objectAtIndex:row] forKey:[NSString stringWithFormat:@"%ld",(long)self.tag]];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"DataUpdated"
                                                        object:selectedListDict];
